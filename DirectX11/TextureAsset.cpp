...
TextureAsset::TextureAsset(
	...
	: AAssetFile(AssetNameIn + AssetSuffix[GetAssetTypeAsIndex(EAssetType::Texture)], EAssetType::Texture)
{
...
void TextureAsset::CreateTexture(uint8_t* ImageBufferIn, const UINT& WidthIn, const UINT& HeightIn)
{
	...
	DeviceContext->VSSetShaderResources(0, 1, SRV.GetAddressOf());
}
