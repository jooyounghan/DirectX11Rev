...
const FLOAT Camera::IDClearColor[4] = { 1.f, 1.f, 1.f, 1.f };

Camera::Camera(MapAsset* MapAssetInstance, const UINT& WidthIn, const UINT& HeightIn)
	: Viewable(MapAssetInstance, WidthIn, HeightIn)
{
...
UINT Camera::GetID(const float& RelativeMousePosX, const float& RelativeMousePosY, const float& WindowSizeX, const float& WindowSizeY)
{
