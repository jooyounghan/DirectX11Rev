...
enum class EComponentPSOVertexShader
{
	...
	STATIC_MESH,
	SKELETAL_MESH,
	STATIC_MESH_SPOT_LIGHT_DEPTH_TEST,
	SKELETAL_MESH_SPOT_LIGHT_DEPTH_TEST,
	STATIC_MESH_POINT_LIGHT_DEPTH_TEST,
	SKELETAL_MESH_POINT_LIGHT_DEPTH_TEST,
};
...
enum class EComponentPSODeptshStencilState
{
	...
	DEPTH_COMPARE_LESS_STENCIL_REPLACE,
